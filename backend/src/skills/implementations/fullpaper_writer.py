...
# Standard academic paper sections in order (legacy order)
PAPER_SECTIONS = [
    "introduction",
    "related_work",
    "methodology",
...
class FullpaperWriterSkillV2(BaseSkill):
    ...
    def __init__(self, llm_service: MockLLMService | None = None):
        """Initialize the FullpaperWriterSkillV2.
...
# Backward compatibility: alias the original class name to V2
# This allows existing code to use FullpaperWriterSkill and get the V2 behavior
