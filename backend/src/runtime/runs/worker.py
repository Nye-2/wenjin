...
async def _set_idle_status_if_no_other_active_runs(
    *,
    ...
    *,
    ...
    try:
        ...
        if await run_manager.is_abort_requested(run_id):
            ...
            if prepared is not None:
                await _set_idle_status_if_no_other_active_runs(
        ...
        await run_manager.set_status(run_id, RunStatus.error, error=exc.message)
        await bridge.publish(
            run_id,
            "error",
