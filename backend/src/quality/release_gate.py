...
CHECK_DESCRIPTIONS: Mapping[str, str] = {
    ...
    "native_harness_quality_gate": "Run Wenjin-native harness filesystem, sandbox, citation/source audit, and mock sandbox E2E tests.",
