...
CHECK_DESCRIPTIONS: Mapping[str, str] = {
    ...
    "native_harness_quality_gate": "Run Wenjin-native harness filesystem, context, sandbox, citation/source audit, and mock sandbox E2E tests.",
...
CHECK_FIX_HINTS: Mapping[str, str] = {
    ...
    "native_harness_quality_gate": "Run `PYTHONPATH=. uv run pytest tests/agents/harness/test_scheduler_and_python_tool.py tests/agents/harness/test_sandbox_file_tools.py tests/agents/harness/test_langchain_adapter.py tests/agents/harness/test_context_assembly.py tests/agents/lead_agent/v2/test_workspace_sandbox_manager.py tests/sandbox/test_workspace_layout.py tests/agents/lead_agent/v2/test_sandbox_artifact_discovery.py tests/agents/lead_agent/v2/test_citation_source_audit.py tests/agents/lead_agent/v2/test_team_quality_gates.py tests/integration/test_harness_mock_sandbox_e2e.py -q` and fix native harness regressions.",
