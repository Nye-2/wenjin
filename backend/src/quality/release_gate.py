...
CHECK_DESCRIPTIONS: Mapping[str, str] = {
    ...
    "native_harness_quality_gate": "Run Wenjin-native harness filesystem, policy, command audit, output budget, context, sandbox, citation/source audit, and mock sandbox E2E tests.",
