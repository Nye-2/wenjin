...
from src.sandbox.workspace_layout import (
    ...
    build_agent_workspace_task_contract,
...
def build_harness_context_bundle(
    *,
    ...
    bundle = {
        ...
        "statistical_robustness_summary": _latest_harness_summary(
            safe_workspace_data,
    ...
    return fit_context_bundle_to_budget(
        bundle,
        budget,
        render=render_harness_context_for_prompt,
    )
...
def _task_contract(task: dict[str, Any]) -> dict[str, Any]:
    ...
    return build_agent_workspace_task_contract(
