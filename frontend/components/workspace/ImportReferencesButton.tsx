...
export function ImportReferencesButton({
  ...
  return (
    <button
      ...
      className={cn(
        "inline-flex items-center gap-2 rounded-xl border border-[var(--wjn-line)] bg-[var(--wjn-surface-subtle)] px-3 py-2 text-[11px] font-medium text-[var(--wjn-text)] transition-colors hover:bg-[var(--wjn-surface-muted)] disabled:opacity-60",
        className
      )}
    >
      {isImporting ? (
