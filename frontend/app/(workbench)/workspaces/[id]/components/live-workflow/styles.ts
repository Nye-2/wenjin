...
export const styles: Record<string, CSSProperties> = {
  ...
  guidanceNoteWarning: {
    ...
    background: "linear-gradient(180deg, rgba(255,247,237,0.82), rgba(255,255,255,0.72))",
  ...
  progressInner: {
    height: "100%",
    borderRadius: 8,
    background: "linear-gradient(90deg, var(--wjn-blue), var(--wjn-evidence))",
    transition: "width 220ms var(--wjn-ease-standard)",
  },
  progressMeta: {
    display: "flex",
    flexWrap: "wrap",
