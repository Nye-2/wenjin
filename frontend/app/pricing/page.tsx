        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-16 grid gap-4 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="rounded-[1.75rem] border border-[rgba(16,24,40,0.08)] bg-white p-7 shadow-[0_18px_60px_rgba(16,24,40,0.06)]">
              ...
              <h2 className="mt-6 text-3xl font-bold leading-tight text-[var(--wjn-text)]">
                {copy.note.title}
              </h2>
            ...
            <div className="grid gap-4 md:grid-cols-3">
              {copy.cards.map((card) => (
                ...
                >
                  <h3 className="text-lg font-bold leading-tight text-[var(--wjn-text)]">
                    {card.title}
                  </h3>
                  <p className="mt-4 text-sm leading-7 text-[var(--wjn-text-secondary)]">{card.body}</p>
