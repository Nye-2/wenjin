...
const view = {
  ...
  activity: {
    ...
    attempt: null,
    retry_at: null,
    last_progress_at: "2026-07-11T08:00:00Z",
  ...
  current_operation: {
    ...
    label: "正在交叉核验方法与评测文献",
    actor: "研究成员",
    started_at: "2026-07-11T07:59:00Z",
    attempt: 1,
  },
  ...
  subagents: [{ subagent_id: "member-1", display_name: "严谨派阿澈", role_label: "方法与实验审校", status: "working", summary: "核验 Non-IID 实验设定", milestones: [] }],
  ...
  artifact_items: [],
  artifact_page: { total: 0, returned: 0, next_cursor: null, revision: "artifact-revision-empty" },
