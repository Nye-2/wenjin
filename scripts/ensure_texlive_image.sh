...
IMAGE_NAME="${TEXLIVE_IMAGE_NAME:-academiagpt/texlive:2024}"
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(cd "$SCRIPT_DIR/.." && pwd)"

IMAGE_TAR_PATH="${TEXLIVE_IMAGE_TAR:-$PROJECT_ROOT/backend/docker/images/texlive/academiagpt-texlive-2024.tar}"
