...
总计: 5 个 workspace 类型，15 个 feature。
...
|---|---|---|---|---|---|
| `deep_research` | 深度调研 | `thesis.deep_research` | `deep_research` | `deep_research_panel` | `search/analyze/synthesize` |
...
3. `task_type` 会影响任务路由和计费策略，变更时必须同步回归测试。
