...
- Verification after the Source curation/evidence/indexer/asset slice is green through `cd /Users/ze/wenjin/backend && .venv/bin/python -m pytest tests/ -q` with 1935 backend tests.
