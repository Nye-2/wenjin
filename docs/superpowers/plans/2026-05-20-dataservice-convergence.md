...
- Verification after the Source curation/evidence/indexer/asset/upload-preprocess cleanup slice is green through `cd /Users/ze/wenjin/backend && .venv/bin/python -m pytest tests/ -q` with 1934 backend tests.
