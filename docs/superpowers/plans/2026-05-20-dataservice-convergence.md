...
- Workspace decisions, memory, tasks, and settings endpoints now call DataService APIs directly, and their old room facade files have been deleted. Remaining room endpoint adapters are limited to library, documents, and sandbox while their route contracts are still being cut over.
