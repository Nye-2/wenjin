...
- Remaining Prism review debt is now localized to legacy LaTeX adapter apply/reject/defer/revert endpoints plus old source-link/protected-section operations; these should move to review handlers, Prism file-version commands, provenance links, and Prism protected scopes.
