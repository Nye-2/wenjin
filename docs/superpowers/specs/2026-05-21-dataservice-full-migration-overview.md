...
- The former decisions, memory, workspace tasks, and settings room facades have been removed; their workspace room endpoints now use DataService APIs directly. Remaining room endpoint adapters are library, documents, and sandbox.
