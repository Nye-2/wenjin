...
- The former decisions, memory, workspace tasks, settings, and sandbox room facades have been removed; their workspace room endpoints now use DataService APIs directly. Remaining room endpoint adapters are library and documents.
