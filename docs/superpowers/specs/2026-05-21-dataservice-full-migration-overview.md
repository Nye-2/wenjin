...
- The former decisions, memory, and workspace tasks room facades have been removed; their workspace room endpoints now use the DataService Rooms API directly. Remaining room endpoint adapters are library, documents, settings, and sandbox.
