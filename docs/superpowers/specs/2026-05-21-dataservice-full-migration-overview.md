...
- The former decisions, memory, workspace tasks, settings, sandbox, and library room facades have been removed; their workspace room endpoints now use DataService APIs directly. The remaining room endpoint adapter is documents.
