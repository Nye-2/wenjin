...
- Verification through the Source curation/BibTeX/citation-middleware slice is green through `cd backend && .venv/bin/python -m pytest tests/ -q` with 1930 backend tests.
