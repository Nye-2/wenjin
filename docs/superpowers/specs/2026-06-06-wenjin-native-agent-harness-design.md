...
- Large outputs: materialize through DataService-owned sandbox artifact, workspace asset, or execution event payload reference and return a compact reference.
