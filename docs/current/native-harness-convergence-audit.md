...
现在可以产出 literature items 和质量门 warning，但 citation readiness、DOI/BibTeX 校验、claim-source 绑定还没有形成强制闭环。下一步应把 source-quality-auditor / citation-auditor 的输出变成更明确的 review item 或质量门决策。
