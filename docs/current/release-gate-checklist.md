...
最新验证：2026-05-21 DataService / Prism / Conversation cleanup：backend full pytest 1935 passed；frontend typecheck / lint passed；Alembic single head 为 `074_drop_legacy_thread_messages_column`。2026-05-20 workspace Prism rollout baseline：frontend unit 200 passed / production build 通过；full Playwright E2E 19 passed, 1 skipped；`docker compose config --quiet` 通过。
