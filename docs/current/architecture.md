...
6. Prism 写作结果不直接覆盖 `/workspace/main` 或 Prism project；必须 stage 为 canonical `prism_file_change` review item，再由用户 preview/apply/reject。
