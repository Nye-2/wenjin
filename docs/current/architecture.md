...
- Prism adapter metadata 使用 canonical `source_metadata` 承接原始 project metadata；`legacy_metadata` 不属于运行时 API 或 surface projection
